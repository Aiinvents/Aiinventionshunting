...
const kitchenInventions = [

    {
        ...
        link: "https://sdk.minepi.com/pi-sdk.js"
    },
...
/* =========================================================
   GENERATOR + SHOPPING LOGIC
========================================================= */

let currentCategory = null;
let currentProductArray = null;
let currentProduct = null;


/* Maps each category button to its product array */

const categoryMap = {

    "Kitchen Inventions": kitchenInventions,

    "Beauty Inventions": beautyInventions,

    "Outdoor Gear Inventions": outdoorGearInventions,

    "Bathroom": bathroom,

    "School": school,

    "Laundry room": laundryRoomInventions,

    "Bedroom": bedroom,

    "Workplace items": workplaceItems,

    "Automobile inventions": automobileInventions,

    "Working out inventions": workingOutInventions,

    "Gardening inventions": gardeningInventions
...
function generateProduct() {
    ...
    outputDiv.innerHTML =
        "<strong>AI is searching for an invention...</strong>";


    /*
       Short delay instead of making
       visitors wait several seconds.
    */
...
function getProductTitle(productText) {
...
function getProductDescription(productText) {
...
function displayProduct(product) {
    ...
    */
    ...
    if (generateAgainButton) {
        ...
        generateAgainButton.addEventListener(
            "click",
            generateProduct
        );
...
/* =========================================================
   RESET IF USER RETURNS USING BACK BUTTON
========================================================= */
...
window.addEventListener(
    ...
    function (event) {
        ...
        if (outputDiv) {
            ...
            outputDiv.innerText =
                "Choose a category below and discover something useful.";
